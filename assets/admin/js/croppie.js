...
(function (root, factory) {
    ...
    function _result(options) {
        ...
        if (size === 'viewport') {
            data.outputWidth = 737;
            data.outputHeight = 440;
    ...
    function _result_thumb(options) {
        var self = this,
            data = _get.call(self),
            opts = deepExtend(RESULT_DEFAULTS, deepExtend({}, options)),
            type = (typeof (options) === 'string' ? options : (opts.type || 'viewport')),
    ...
    if (window.jQuery) {
        ...
        $.fn.croppie_thumb = function (opts) {
            var ot = typeof opts;
            ...
            if (ot === 'string') {
                ...
                if (opts === 'get') {
                    ...
                    return singleInst.result_thumb.apply(singleInst, args);
                }
                else if (opts === 'bind') {
                    return singleInst.bind.apply(singleInst, args);
                }
    ...
    deepExtend(Croppie.prototype, {
        ...
        result_thumb: function (type) {
            return _result_thumb.call(this, type);
        },
        refresh: function () {
