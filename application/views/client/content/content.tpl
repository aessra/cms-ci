        ...
        <header>
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 image-left text-center not-home animated rotateInDownLeft">
                        <small class="small-header">{{ header.page | capitalize }}</small>
                        <a href="{{ header.seo_url }}">
                            <img src="{{ base_url }}assets/img/background.png" data-original="{{ base_url() }}{{ contents_image_path }}{{ header.name }}" class="img img-responsive" alt="{{ header.tag }}">
                        </a>
                        <small class="triangle-caption"></small>
                        <div class="small-review-footer">
                            <small class="text-center"><a href="{{ header.seo_url }}">{{ header.content_title }}</a></small>
                        </div>
                    </div>
                    <div class="col-sm-6 image-right animated rotateInDownRight">
                        <div class="content-caption-text">
                            <img src="{{ base_url() }}assets/img/background.png" class="img img-responsive">
                            <div class="caption-text">
                                <h1>
                                    <a href="{{ header.seo_url }}">{{ header.content_title }}</a>
                                </h1>
                                <small class="contributor">Posted on {{ header.date }} by {{ header.fullname }}</small>
                                <p class="caption-detail">{{ caption_text }}....</p>
                                <p class="caption-share"><i class="fa fa-facebook-square" aria-hidden="true"></i> <i class="fa fa-share-square-o" aria-hidden="true"></i> <i class="fa fa-twitter-square" aria-hidden="true"></i></p>
                                <a href="{{ header.seo_url }}" class="btn btn-custom">Read more</a>
                            </div>
                        </div>
                    </div>
                </div>
